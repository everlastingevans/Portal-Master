...
export const PlatformVision = () => {
  ...
  return (
    <section id="what-we-do" className="bg-[#0A1B3D] px-6 py-24 md:py-32 border-y border-slate-100/60">
      <div className="mx-auto max-w-[1400px] space-y-16">
        ...
        <Reveal>
          <div className="text-center max-w-3xl mx-auto space-y-5">
            ...
            <h2 className="text-[40px] font-mono font-bold leading-[1.1] text-[#fff] md:text-[52px]">
              Platform Vision &amp; Product Features
            </h2>
            <p className="text-[17px] leading-relaxed text-[#fff]">
        ...
        <Reveal delay={100}>
          <div className="flex justify-center">
            <div className="inline-flex p-1.5 bg-[#0A1B3D] border rounded-full">
              <button
                onClick={() => setActiveTab("candidate")}
                className={`flex items-center gap-2.5 px-6 py-3 rounded-full text-sm font-mono font-bold transition-all cursor-pointer ${
                  activeTab === "candidate"
          ...
          {activeTab === "candidate" ? (
            <div className="grid lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-7 grid md:grid-cols-2 gap-6">
                ...
                {/* Item A */}
                <Reveal delay={120} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">Smart Profile Creation</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                ...
                {/* Item B */}
                <Reveal delay={180} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">AI Candidate Scoring</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                ...
                {/* Item C */}
                <Reveal delay={240} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">Job Matching Engine</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                ...
                {/* Item D */}
                <Reveal delay={300} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">Career Development Tools</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
              ...
              <div className="lg:col-span-5 flex">
                <Reveal delay={350} className="w-full bg-white border p-8 rounded-3xl flex flex-col justify-between relative overflow-hidden shadow-sm">
                  ...
                  <div className="space-y-6">
                    <div className="inline-flex px-3 py-1 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 text-xs font-mono font-bold rounded-full font-mono">
                      CANDIDATE DASHBOARD
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-2xl font-mono font-bold text-slate-900 dark:text-white font-heading">Interactive Pipeline Trackers</h3>
                      <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                    ...
                    <div className="space-y-3.5 pt-2">
                      {[
                        ...
                        <div key={idx} className="flex items-start gap-3">
                          <div className="mt-0.5 w-5 h-5 rounded-full bg-violet-100 dark:bg-violet-950/60 text-[#5D3FD3] dark:text-violet-300 flex items-center justify-center text-xs font-mono font-bold">
                            {idx + 1}
                          </div>
                          <div>
                            <p className="text-[15px] font-mono font-bold text-slate-800 dark:text-slate-200 leading-tight">{stage.label}</p>
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-7 grid md:grid-cols-2 gap-6">
                ...
                <Reveal delay={120} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">Employer Dashboard</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                ...
                <Reveal delay={180} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">Job Creation Flow</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                ...
                <Reveal delay={240} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">Instant Matching</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                ...
                <Reveal delay={300} className="bg-white border p-6 rounded-3xl space-y-4 hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg font-mono font-bold text-slate-900 dark:text-white">Interactive Shortlists</h3>
                  <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
              ...
              <div className="lg:col-span-5 flex">
                <Reveal delay={350} className="w-full bg-white border p-8 rounded-3xl flex flex-col justify-between relative overflow-hidden shadow-sm">
                  ...
                  <div className="space-y-6">
                    <div className="inline-flex px-3 py-1 bg-[#5D3FD3]/10 text-[#5D3FD3] text-xs font-mono font-bold rounded-full font-mono">
                      EMPLOYER CRM &amp; METRICS
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-2xl font-mono font-bold text-slate-900 dark:text-white font-heading">Hiring Pipeline &amp; Analytics</h3>
                      <p className="text-[16px] font-mono text-[#0A1B3D] leading-relaxed">
                    ...
                    <div className="space-y-4 pt-2">
                      <div className="space-y-1">
                        <p className="text-xs font-mono font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest font-mono">Pipeline CRM Stages</p>
                      ...
                      <div className="border-t border-slate-100 pt-3 space-y-3">
                        <p className="text-xs font-mono font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest font-mono">Embedded Analytics Metrics</p>
                        <div className="grid grid-cols-2 gap-3 text-xs">
                          <div className="p-2.5 bg-slate-50 dark:bg-slate-850 rounded-xl">
                            <span className="block font-mono font-bold text-slate-800 dark:text-slate-200">Time to Hire</span>
                            <span className="text-slate-500">Average under 6 days</span>
                          </div>
                          <div className="p-2.5 bg-slate-50 dark:bg-slate-850 rounded-xl">
                            <span className="block font-mono font-bold text-slate-800 dark:text-slate-200">Conversion Rates</span>
                            <span className="text-slate-500">Industry-leading ratios</span>
                          </div>
                          <div className="p-2.5 bg-slate-50 dark:bg-slate-850 rounded-xl">
                            <span className="block font-mono font-bold text-slate-800 dark:text-slate-200">Applicants per Role</span>
                            <span className="text-slate-500">Curated shortlists of 3-5</span>
                          </div>
                          <div className="p-2.5 bg-slate-50 dark:bg-slate-850 rounded-xl">
                            <span className="block font-mono font-bold text-slate-800 dark:text-slate-200">Cost Per Hire</span>
              ...
              <div className="md:col-span-5 grid grid-cols-2 gap-3.5">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2 p-3 bg-white/5 border border-white/10 rounded-xl">
                    ...
                    <span className="text-[15px] font-mono font-bold text-slate-200">{item}</span>
                  </div>
                ))}
              </div>
            </div>
